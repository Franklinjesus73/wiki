        ...
        if form.is_valid():
            ...
            for i in entries:
                if item in entries:
                    ...
                    context = {'page': page_converted,'title': item,'form': Search()}
...
def randomP(request):
    if request.method == 'GET':
        ...
        context={'form': Search(),'page': page_converted,'title': page_random}
...
def entryPage(request,title):
    ...
    if title in entries:
        ...
        context={"page":page_converted,"title":title,"form":Search()}
...
def editPage(request,title):
    if request.method == "GET":
        ...
        context={"form": Search(),"edit": Edit(initial={'textarea': page}),"title": title}
        ...
        if form.is_valid():
            ...
            context={"form": Search(),"page": page_converted,"title": title}
